  ...
  return (
    ...
    >
      <div className="pb-12 sm:pb-20 lg:pb-[120px]  max-w-5xl mx-auto">
        ...
        <p className="font-marlton relative w-fit mx-auto text-[#191717] text-center text-2xl pt-4 sm:text-3xl lg:text-[42px] flex items-end gap-2 sm:gap-3 justify-center flex-wrap -mt-3 md:mt-0">
          <span
